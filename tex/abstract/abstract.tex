...
inductive construction as initial object in fibrational F,G-dialgebras (or F-algebra
...
\begin{lstlisting}[mathescape=true]
    record pure: (P: * $\rightarrow$ *) $\rightarrow$ (A: *) $\rightarrow$ * :=
           (return: P A)

    record functor: (F: * $\rightarrow$ *) $\rightarrow$ (A, B: *) $\rightarrow$ * :=
           (fmap: (A $\rightarrow$ B) $\rightarrow$ F A $\rightarrow$ F B)

    record applicative: (F: * $\rightarrow$ *) $\rightarrow$ (A, B: *) $\rightarrow$ *
    extend pure F A, functor F A B :=
           (ap: F (A $\rightarrow$ B) $\rightarrow$ F A $\rightarrow$ F B)

    record monad: (F: * $\rightarrow$ *) $\rightarrow$ (A, B: *) $\rightarrow$ *
    extend pure F A, functor F A B :=
