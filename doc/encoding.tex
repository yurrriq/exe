...
\begin{lstlisting}[mathescape=true]
        record Cat: Type := 
               (Ob: Type)
               (Hom: $\forall$ (a,b: Ob) $\rightarrow$ Setoid)
               (id: $\forall$ (o$_0$: Ob) $\rightarrow$ Hom o$_0$ o$_0$)
               ($\circ$: $\forall$ (o$_1$,o$_2$,o$_3$: Ob) $\rightarrow$ Hom o$_2$ o$_3$ $\rightarrow$ Hom o$_1$ o$_2$ $\rightarrow$ Hom o$_1$ o$_3$)
               (1$_L$: $\forall$ (x,y: Ob) $\rightarrow$ $\forall$ (f: hom x y) $\rightarrow$ id $\circ$ f = f)
               (1$_R$: $\forall$ (x,y: Ob) (f: hom x y) $\rightarrow$ f = id $\circ$ f)
               (Assoc: $\forall$ (x,y,z,w: Ob) (f: Hom z w) (g: Hom y z) (h: Hom x y) 
